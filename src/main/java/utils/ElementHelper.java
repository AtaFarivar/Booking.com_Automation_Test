...
public class ElementHelper {
    ...
    public void waitForAttributeContains(By by, String attribute, String expectedValue) {
        wait.until(ExpectedConditions.attributeContains(by, attribute, expectedValue));
    }
